  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M9 8H7V12H9V21H13V12H15.828L16 8H13V6.5C13 5.94771 13.4477 5.5 14 5.5H16V2H13.5C11.567 2 10 3.567 10 5.5V8H9Z"
            fill="currentColor"
          />
          <path
            d="M24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24C18.6274 24 24 18.6274 24 12ZM22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
            fill="currentColor"
          />
        </svg>
      ),
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/azyygndb"
          method="POST"
